...
const {
  createVehicle, getVehicleById, getAllVehicles, updateVehicle, deleteVehicle
...
describe('Controladores', () => {
  ...
  describe('Obtener todos los vehiculos', () => {
    ...
    test('Caso error', async () => {
      ...
      const responseController = { statusCode: 404, message: 'Vehiculos no encontrados' };
  ...
  describe('Modificar vehiculo', () => {
    ...
    test('Caso error', async () => {
      ...
      const responseController = { "statusCode": 400, "message": "Nombre de vehiculo existente" };
  ...
  describe('Eliminar vehiculo', () => {
    test('Caso exito', async () => {
      ...
      const responseService = { "status": "success", "code": 200, "message": "Vehiculo eliminado satisfactoriamente", "number_records": 1 };
      const responseController = {
        statusCode: 200,
    ...
    test('Caso error', async () => {
      ...
      const responseController = { statusCode: 404, message: 'Vehiculo no encontrado' };
