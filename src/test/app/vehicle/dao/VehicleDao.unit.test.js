...
describe("DAO", () => {
  describe("Crear vehiculo", () => {
    test("Caso exito", async () => {
      const request = {
        ...
        id: "074bf0b0-28d0-11ee-9d90-d53c52e09ab6",
      };
      const responseSchema = {
        ...
        peliculas: ["https://swapi.py4e.com/api/films/2/"],
        url: "https://swapi.py4e.com/api/vehicles/14/",
        id: "d05ab190-28cf-11ee-957f-b325033060b9",
        creado: 1690058351402,
        editado: 1690058351402,
      };
      const responseDao = {
        nombre: "Snowspeederw",
        modelo: "t-47 airspeeder",
    ...
    test("Caso error", async () => {
      ...
      const responseSchema = {
        statusCode: 500,
        message: "No se pudo crear Vehiculo",
      };
      const responseDao = {
        statusCode: 500,
        message: "No se pudo crear Vehiculo",
  ...
  describe("Obtener todos los vehiculos fuente interna", () => {
    test("Caso exito sin filtros", async () => {
      ...
      const responseSchema = [
        {
          ...
          costo_en_creditos: "unknown",
          modelo: "t-47 airspeeder",
          editado: "2023-07-22T19:48:59.593Z",
          fabricante: "Incom corporation",
          clase_vehiculo: "airspeeder",
          creado: "2023-07-22T19:48:59.593Z",
          id: "cd2d1c80-28c8-11ee-b246-8d466e53189a",
          longitud: "4.5",
          pasajeros: "0",
        },
        {
          ...
          costo_en_creditos: "unknown",
          modelo: "t-47 airspeeder",
          editado: "2023-07-22T20:40:43.579Z",
          fabricante: "Incom corporation",
          clase_vehiculo: "airspeeder",
          creado: "2023-07-22T20:40:43.579Z",
          id: "074bf0b0-28d0-11ee-9d90-d53c52e09ab6",
          longitud: "4.5",
          pasajeros: "0",
        },
        {
          ...
          costo_en_creditos: "unknown",
          modelo: "t-47 airspeeder",
          editado: "2023-07-22T20:39:11.402Z",
          fabricante: "Incom corporation",
          clase_vehiculo: "airspeeder",
          creado: "2023-07-22T20:39:11.402Z",
          id: "d05ab190-28cf-11ee-957f-b325033060b9",
          longitud: "4.5",
          pasajeros: "0",
        },
      ...
      schema.scan = jest.fn().mockImplementationOnce(() => ({
        exec: jest.fn().mockResolvedValueOnce(responseSchema),
      }));
    ...
    test("Caso error", async () => {
      ...
      schema.scan = jest.fn().mockImplementationOnce(() => ({
        exec: jest.fn().mockRejectedValueOnce(responseSchema),
      }));
      try {
  ...
  describe("Obtener vehiculo(s) por nombre", () => {
    test("Caso exito", async () => {
      ...
      schema.query = jest.fn().mockImplementationOnce(() => ({
        exec: jest.fn().mockResolvedValueOnce(responseSchema),
      }));
  ...
  describe("Obtener vehiculo por Id", () => {
    test("Caso exito", async () => {
      ...
      const result = await dao.getVehicleById(
        "cd2d1c80-28c8-11ee-b246-8d466e53189a",
      );
      expect(result).toStrictEqual(responseDao);
    });
    test("Caso error", async () => {
  ...
  describe("Modificar vehiculo", () => {
    test("Caso exito", async () => {
      const request = {
        ...
        url: "https://swapi.py4e.com/api/vehicles/24/",
        id: "6c0f6620-284f-11ee-92be-f1b1944acfa9",
      };
      const responseSchema = {
        nombre: "Sail barge",
        capacidad_carga: "2000000",
        ...
        costo_en_creditos: "285000",
        modelo: "Modified Luxury Sail Barge",
        editado: "2023-07-22T22:31:38.046Z",
        fabricante: "Ubrikkian Industries Custom Vehicle Division",
        clase_vehiculo: "sail barge",
        id: "6c0f6620-284f-11ee-92be-f1b1944acfa9",
        longitud: "30",
    ...
    test("Caso error", async () => {
      ...
      const responseSchema = {
        statusCode: 500,
        message: "No se pudo modificar el Vehiculo",
      };
      const responseDao = {
        statusCode: 500,
        message: "No se pudo modificar el Vehiculo",
  ...
  describe("Eliminar vehiculo", () => {
    test("Caso exito", async () => {
      ...
      const result = await dao.deleteVehicle(
        "cd2d1c80-28c8-11ee-b246-8d466e53189a",
      );
      expect(result).toStrictEqual(responseDao);
    });
